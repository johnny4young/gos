...
run ruby -e 'require "yaml"; YAML.load_file(".github/workflows/ci.yml"); YAML.load_file(".github/workflows/release.yml"); YAML.load_file(".github/workflows/canary.yml"); YAML.load_file(".github/workflows/scorecard.yml")'
run git diff --check
