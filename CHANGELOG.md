...
- Reject invalid `install.sh` arguments and ambiguous `GOS_BIN_DIR` paths before network access, and keep optional gos release checks HTTPS-only and time-bounded.
